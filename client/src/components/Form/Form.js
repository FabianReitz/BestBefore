    ...
    return (
        <Paper className={classes.paper}>
            <form autoComplete="off" noValidate className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit}>
                ...
                <TextField name="purchaseDate" variant="outlined" label="Kaufdatum" fullWidth value={itemData.purchaseDate} onChange={(e) => setItemData({ ...itemData, purchaseDate: e.target.value })} />

                <TextField name="bestBeforeDate" variant="outlined" label="Mindesthaltbarkeitsdatum" fullWidth value={itemData.bestBeforeDate} onChange={(e) => setItemData({ ...itemData, bestBeforeDate: e.target.value })} />
